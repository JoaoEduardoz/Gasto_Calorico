...
if sexo == 'F' or 'f' and idade >= 0 and idade <= 3 :
    print(f"Gasto Calórico Aproximado: {gasto_0a3_anos_mulher:.0f} Kcal Diárias.")

elif sexo == 'M' or 'm' and idade >= 0 and idade <= 3 :
    print(f"Gasto Calórico Aproximado: {gasto_0a3_anos_homem:.0f} Kcal Diárias.")

# 3 a 10 anos 
elif sexo == 'F' or 'f' and idade > 3 and idade <= 10 :
    print(f"Gasto Calórico Aproximado: {gasto_10a18_anos_mulher:.0f} Kcal Diárias.")

elif sexo == 'M' or 'm' and idade > 10 and idade <= 18 :
    print(f"Gasto Calórico Aproximado: {gasto_10a18_anos_homem:.0f} Kcal Diárias.")

# 18 a 30 anos
elif sexo == 'F' or 'f' and idade > 18 and idade <= 30 :
    print(f"Gasto Calórico Aproximado: {gasto_18a30_anos_mulher:.0f} Kcal Diárias.")

elif sexo == 'M' or 'm' and idade > 18 and idade <= 30 :
    print(f"Gasto Calórico Aproximado: {gasto_18a30_anos_homem:.0f} Kcal Diárias.")

# 30 a 60 anos
elif sexo == 'F' or 'f' and idade > 30 and idade <= 60 :
    print(f"Gasto calórico estimado: {gasto_30a60_anos_mulher:.0f} Kcal Diárias.")

elif sexo == 'M' or 'm' and idade > 30 and idade <= 60 :
    print(f"Gasto Calórico Aproximado: {gasto_30a60_anos_homem:.0f} Kcal Diárias.")

# Maior que 60 anos de idade
elif sexo == 'F' or 'f' and idade > 60 :
    print(f"Gasto Calórico Aproximado: {gasto_maior_que_60_anos_mulher:.0f} Kcal Diárias.")

elif sexo == 'M' or 'm' and idade > 60 :
    print(f"Gasto calórico Aproximado: {gasto_maior_que_60_anos_homem:.0f} Kcal Diárias.")